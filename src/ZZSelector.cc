...
void ZZSelector::Init(TTree *tree)
{
    ...
    hists1D_ = {
         ...
         "Mass","nJets","jetPt[0]","jetPt[1]","jetPt[01]","jetPhi[0]","jetPhi[1]","jetEta[0]","jetEta[1]","jetEta[01]","absJetEta","absJetEta50","absJetEta_refine","jetPt_refine","jetPhi_refine","absJetEta[0]_refine","absJetEta[1]_refine","absJetEta[0]50_refine","absJetEta[1]50_refine","mjj","dEtajj","CosTheta","zeppenfeld"
    };
